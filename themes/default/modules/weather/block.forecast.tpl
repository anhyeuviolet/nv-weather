...
<div class="panel-body">
    ...
    <div class="gic" style="margin-bottom:-1px;padding:0;padding-bottom:1px;">
        <div style="padding-top: 7px; white-space: nowrap; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px); transition: -moz-transform 0ms ease-in-out 0s;" id="wob_dp">
            <!-- BEGIN: forecast -->
            <div class="wob_df wob_ds" style="display:inline-block;line-height:1;text-align:center;transition-duration:200ms,200ms,200ms;transition-property:background-image,border,font-weight;font-weight:13px;height:90px;width:50px">
                <div class="vk_lgy" style="padding-top:7px;line-height:15px">{DATA.date}</div>
                <div style="display:inline-block">
                    <img style="margin:1px 4px 0;height:25px;width:25px" alt="{DATA.description}" title="{DATA.description}" src="http://openweathermap.org/img/w/{DATA.icon}.png"/></div>
